...
export class PlanPreviewView {
  ...
  onPlanFieldChange?: (field: 'repair_mode' | 'repair_method' | 'fight_condition' | 'fleet_id' | 'times' | 'gap' | 'loot_count_ge' | 'ship_count_ge', value: number | RepairMethod | undefined) => void;
